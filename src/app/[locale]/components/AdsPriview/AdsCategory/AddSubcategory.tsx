...
function AddSubcategory({subcatotitle,subcatoId}:any) {
  ...
  const handleSubcategorySelect = (subcategoryId: string) => {
    ...
    if (currentQuery.has("subcategory") && currentQuery.get("subcategory") === subcategoryId) {
    ...
    <div>
      <li>
        <label className="inline-flex items-center">
          <input type="checkbox" className="form-checkbox"  onChange={() => handleSubcategorySelect(subcatoId)}/>
